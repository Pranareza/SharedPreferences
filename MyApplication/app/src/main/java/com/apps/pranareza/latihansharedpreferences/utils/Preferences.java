package com.apps.pranareza.latihansharedpreferences.utils;

import android.content.Context;
import android.content.SharedPreferences;

import com.apps.pranareza.model.UserModel;

public class Preferences {
    private static final String PREF_SESSION = "com.apps.pranareza.latihansharedpreferences.session";
